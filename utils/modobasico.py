...
from utils.commons import transcribir_whisper, guardar_transcripcion
...
# ----------------------------------------------------------
# Transcripcion modo basico
# ----------------------------------------------------------
print(f"[+] Transcribiendo archivo: {archivo_entrada}")
resultado = transcribir_whisper(archivo_entrada, modelo="small")
...
ruta_txt = os.path.join(salidas_dir, f"{nombre_base}_basico.txt")
ruta_srt = os.path.join(salidas_dir, f"{nombre_base}_basico.srt")
...
# ----------------------------------------------------------
print()
print(f"[OK] Transcripcion completada.")
print(f"[OK] Texto limpio guardado en: {ruta_txt}")
